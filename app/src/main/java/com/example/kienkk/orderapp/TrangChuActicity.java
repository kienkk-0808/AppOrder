...
import com.example.kienkk.orderapp.Fragment.HienThiThongKeFrahment;
...
import com.example.kienkk.orderapp.Fragment.HienThiBanAnFragment;
import com.example.kienkk.orderapp.Fragment.HienThiNhanVienFragment;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.itThongKe:
                ...
                HienThiThongKeFrahment hienThiThongKeFrahment = new HienThiThongKeFrahment();
                tranThongKe.setCustomAnimations(R.anim.hieuung_activity_vao, R.anim.hieuung_activity_ra);
                tranThongKe.replace(R.id.content, hienThiThongKeFrahment);
                tranThongKe.commit();
